...
| --- | --- |
| **KPM Royale** — *Kamen! Papir! Makaze!* ✊ ✋ ✌️. Live tournament, not async. | Both players disconnect in the same match. |
...
| Searching: **can cancel** back to main menu. Disconnect: **20s** grace, then **leaver loses**. |  |
